...
function InsertUbbFace() {
	...
	if(!document.getElementById("UbbFrame").innerHTML && strFaceName){
		...
		for (var i=0;i<aryFileName.length;i++)
		{
			...
			strFaceHtml=strFaceHtml + "<img src=\""+str00+"images/face/"+strFileName+".gif\" title=\""+strFileName+"\" alt=\""+strFileName+"\" width=\""+strFaceSize+"\" height=\""+strFaceSize+"\" onclick=\"InsertText(objActive,'[F]'+this.alt+'[/F]',false);\" style=\"padding:2px;cursor:pointer;\">";
		}
